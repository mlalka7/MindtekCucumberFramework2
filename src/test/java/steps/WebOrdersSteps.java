...
public class WebOrdersSteps {
    ...
    @Given("user navigate to {string} application")
    public void user_navigate_to_application(String string) {

    }


    @When("user enters username {string} and password {string} and click on login button")
    public void user_enters_username_and_password_and_click_on_login_button(String string, String string2) {
